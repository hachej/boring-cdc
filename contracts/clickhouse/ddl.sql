...
(
 capture_epoch UInt64, generation UInt64, logical_table_id FixedString(64), relation_schema_fingerprint FixedString(64),
...
SETTINGS index_granularity=8192,fsync_after_insert=1,fsync_part_directory=1;
CREATE TABLE IF NOT EXISTS boring_cdc.batch_markers_v1
(capture_epoch UInt64,generation UInt64,batch_id FixedString(64),first_journal_seq UInt64,last_journal_seq UInt64,event_count UInt64,ordered_event_digest FixedString(64),object_fingerprint FixedString(64),finalized_at_unix_ms UInt64)
...
(capture_epoch UInt64,promotion_fence UInt64,generation UInt64,table_set_fingerprint FixedString(64),compatible_anchor_id FixedString(64),candidate_digest FixedString(64))
