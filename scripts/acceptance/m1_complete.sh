...
# Consume the M0 scaffold's exact path/owner registry instead of rejecting the
# supervisor-authorized M2 provisional markers that master intentionally preserves.
