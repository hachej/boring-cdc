...
def validate():
 ...
 provisional=['// M0-PROVISIONAL: boring-cdc-d-compose','// M0-PROVISIONAL: boring-cdc-d-keys','// M0-PROVISIONAL: boring-cdc-d-values.1']
 ...
 if c.get('authority',{}).get('owner_cards')!=['59a63169'] or not c.get('authority',{}).get('status','').startswith('engineering artifact with accepted d-values literals'):add(out,'E_AUTHORITY','authority','owner card 59a63169 must remain the literal decision authority')
