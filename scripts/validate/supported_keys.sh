...
try:
 ...
 if spec['approval']!={'approved_at':'2026-09-16T06:05:55.752Z','approved_by':'Julien Hurault (repository owner)','intention_id':'59a63169-9b07-4a00-bbfb-cbed02a7e4ac','selection':'Accept recommended defaults'}: fail()
