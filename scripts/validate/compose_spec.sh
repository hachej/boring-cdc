...
try:
 ...
 ensure(recipe.get('connector_output_digest')=={'m0_requirement':False,'recorded_by':'boring-cdc-m7-artifacts'})
 ...
 ensure(vectors['dependency_delay']['inputs']=={'deadline_seconds':120,'failure_class':'temporary_dependency','ready_at_seconds':121})
 ...
 needed={'ART-M0-COMPOSE-CONTRACT':contract_rel,'ART-M0-COMPOSE-FIXTURE':fixture_rel,'ART-M0-COMPOSE-PROBE':probe_rel,'ART-M0-COMPOSE-VALIDATION':'artifacts/m0/decisions/boring-cdc-d-compose/evidence.json'}
 ...
 anchor=evidence['git_commit']; guarded=[contract_rel,fixture_rel,'scripts/validate/compose_spec.sh','contracts/m0/decisions.json']
