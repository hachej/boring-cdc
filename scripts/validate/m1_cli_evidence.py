...
for p in sorted([root/'src/m1_cli_contract.rs',root/'src/main.rs',root/'tests/fixtures/m1_cli/registry-v1.json',root/'tests/fixtures/m1_cli/envelopes-v1.json']): source.update(p.read_bytes())
...
manifest={
 ...
 'source_preservation':{'preserved':True,'before_sha256':source_digest,'after_sha256':source_digest},
