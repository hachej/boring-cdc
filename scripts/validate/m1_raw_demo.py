...
def seal(kind, transcript):
 ...
 (dest/'versions.json').write_text(json.dumps({'rust':subprocess.check_output(['rustc','--version'],text=True).strip(),'postgres_image':'docker.io/library/postgres:17.6@sha256:00bc86618629af00d2937fdc5a5d63db3ff8450acf52f0636ec813c7f4902929','policy_source':'owner-card:765bd3b2-4b68-4102-a9ec-43ca93357390'},sort_keys=True,indent=2)+'\n')
 packet={'schema_version':'m1-raw-demo-packet/v1','scenario_id':scenario,'seed':SEED,'case_count':len(case_summary),'executed_assertions':sorted(observed),'cases':case_summary,'workload_handoff_sha':data['workload_handoff_sha'],'closure_head':data['closure_head'],'raw_payload_values_recorded':False}
