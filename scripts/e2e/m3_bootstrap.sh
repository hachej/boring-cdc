...
PY
chmod 600 "$work/postgres_password";export BORING_CDC_POSTGRES_PASSWORD_FILE="$work/postgres_password";export PGPASSWORD="$(cat "$BORING_CDC_POSTGRES_PASSWORD_FILE")"
