...
PY
scripts/validate/claims.sh "$tmp/exact.json" --index "$tmp/exact-index.json" --baseline-index tests/fixtures/m0-knowledge/valid/claim-index-baseline.json --owners tests/fixtures/m0-knowledge/valid/owners.json --claim-id CLAIM-M0-KNOWLEDGE-EXACT --actual tests/fixtures/m0-knowledge/valid/actual-exact.json --compatibility tests/fixtures/m0-knowledge/valid/compatibility.json >/dev/null
scripts/validate/claims.sh "$tmp/compatible.json" --index "$tmp/compatible-index.json" --baseline-index tests/fixtures/m0-knowledge/valid/claim-index-baseline.json --owners tests/fixtures/m0-knowledge/valid/owners.json --claim-id CLAIM-M0-KNOWLEDGE-COMPATIBLE --actual tests/fixtures/m0-knowledge/valid/actual-compatible.json --compatibility tests/fixtures/m0-knowledge/valid/compatibility.json >/dev/null
