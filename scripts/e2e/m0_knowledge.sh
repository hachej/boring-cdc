...
PY
scripts/validate/claims.sh "$tmp/exact.json" --index "$tmp/exact-index.json" --actual tests/fixtures/m0-knowledge/valid/actual-exact.json --compatibility tests/fixtures/m0-knowledge/valid/compatibility.json >/dev/null
scripts/validate/claims.sh "$tmp/compatible.json" --index "$tmp/compatible-index.json" --actual tests/fixtures/m0-knowledge/valid/actual-compatible.json --compatibility tests/fixtures/m0-knowledge/valid/compatibility.json >/dev/null
scripts/validate/findings.sh evidence/findings.jsonl >/dev/null
