...
PROVISIONAL_AUTHORITIES = {
 ...
 "contracts/m0/decisions.json":{"boring-cdc-d-compose","boring-cdc-d-sqlite","boring-cdc-d-values.1","boring-cdc-d-wal-cap"},
 ...
 "fixtures/m0/decisions/boring-cdc-d-values.json":{"boring-cdc-d-values.1"},
 ...
 "contracts/clickhouse/model.json":{"boring-cdc-d-compose","boring-cdc-d-keys","boring-cdc-d-values.1"},
 "contracts/event/event-format.json":{"boring-cdc-d-keys","boring-cdc-d-values.1"},
 "contracts/storage/sqlite-schema.sql":{"boring-cdc-d-sqlite"},
 "contracts/storage/storage-model.json":{"boring-cdc-d-admission","boring-cdc-d-archive-durability","boring-cdc-d-compose","boring-cdc-d-sqlite","boring-cdc-d-wal-cap"},
 "docs/CLICKHOUSE_MODEL.md":{"boring-cdc-d-compose","boring-cdc-d-keys","boring-cdc-d-values.1"},
 "docs/EVENT_FORMAT.md":{"boring-cdc-d-keys","boring-cdc-d-values.1"},
 "scripts/lib/core_validator.py":{"boring-cdc-d-compose","boring-cdc-d-sqlite","boring-cdc-d-values.1","boring-cdc-d-wal-cap"},
 ...
 "scripts/validate/supported_values.sh":{"boring-cdc-d-values.1"},
 "scripts/validate/wal_cap.sh":{"boring-cdc-d-wal-cap"},
 "scripts/validate/clickhouse_contract.py":{"boring-cdc-d-compose","boring-cdc-d-keys","boring-cdc-d-values.1"},
 "scripts/validate/event_format.py":{"boring-cdc-d-keys","boring-cdc-d-values.1"},
 "scripts/validate/storage_contract.py":{"boring-cdc-d-admission","boring-cdc-d-archive-durability","boring-cdc-d-compose","boring-cdc-d-sqlite","boring-cdc-d-wal-cap"},
 "tests/test_archive_contract.py":{"boring-cdc-d-archive-durability","boring-cdc-d-compose"},
 "tests/test_clickhouse_contract.py":{"boring-cdc-d-compose","boring-cdc-d-keys","boring-cdc-d-values.1"},
 "tests/test_event_format.py":{"boring-cdc-d-keys","boring-cdc-d-values.1"},
 "tests/test_storage_contract.py":{"boring-cdc-d-admission","boring-cdc-d-archive-durability","boring-cdc-d-compose","boring-cdc-d-sqlite","boring-cdc-d-wal-cap"},
}
