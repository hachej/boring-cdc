...
PROVISIONAL_AUTHORITIES = {
 ...
 "scripts/validate/m0_provisional_reconciliation.py":{"boring-cdc-d-security","boring-cdc-d-keys","boring-cdc-d-values","boring-cdc-d-values.1","boring-cdc-d-sqlite","boring-cdc-d-wal-cap","boring-cdc-d-compose","boring-cdc-d-archive-durability","boring-cdc-m2.1"},
