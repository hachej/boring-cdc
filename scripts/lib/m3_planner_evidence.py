...
fp=sha(canon(cfg));before={'generation_state':'copying','pending_chunks':3,'active_workers':0};after={'generation_state':observed['generation_state'],'keyset_only':mode=='e2e','bounded_reader_released':observed['bounded_reader_released'],'atomic_chunk_event_commit':observed['atomic_chunk_event_commit'],'stale_completion_rejected':observed.get('stale_completion_rejected',False),'limits_respected':observed['limits_respected']}
