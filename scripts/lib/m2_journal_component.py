...
def main():
 ...
 slow=run(["cargo","test","--locked","m2_journal::tests::slow_storage_hold_bound_rolls_back_without_partial_visibility"]); assert slow.returncode==0
 ...
 slow_out=out/'slow-storage-stdout.txt'; slow_err=out/'slow-storage-stderr.txt'; write(slow_out,'slow_storage_hold_bound_rolls_back_without_partial_visibility=pass\n'); write(slow_err,''); slow_display='cargo test --locked m2_journal::tests::slow_storage_hold_bound_rolls_back_without_partial_visibility'; displays.append(slow_display); commands.append(command(slow_display,slow_out,slow_err,'cargo-test/v1'))
