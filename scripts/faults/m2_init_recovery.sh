...
for required in [
 ...
 'M2_INIT_PERMANENT_SLOT_EXISTS','M2_INIT_CONTROL_LENGTH_CONSTRAINT_INVALID']:
...
print('M2_INIT_RECOVERY_FAULTS_OK ambiguous=blocked cardinality=blocked publication_checks=specific privilege=blocked prerequisites=executable fence_lengths=exact slot=never-created')
